              ...
              <div class="dropdown-list-content dropdown-list-icons">
                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                    ...
                    clean it! <span class="time">17 Hours Ago</span>
												...
												fa-bell"></i>
                  </span> <span class="dropdown-item-desc"> Welcome to Edukate
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">  <span
                class="logo-name">Edukate</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown ">
              <a href="{{ route('mainDashboard') }}" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ route('admin.count.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Count</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ route('admin.course.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Courses</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ route('admin.team.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Team</span></a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              <a href="{{ route('admin.students.index') }}" class="nav-link"><i data-feather="monitor"></i><span>New Students</span></a>
            </li>
